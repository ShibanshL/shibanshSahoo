const PC = window.matchMedia("(min-width:1025px)"),
  TAB = window.matchMedia("(max-width:1025px)"),
  PHONE = window.matchMedia("(max-width:501px)");
var mainPage = document.querySelector(".Main_Page"),
  d_height = document.documentElement.clientHeight,
  Button_Mob = document.querySelector(".Main_Page .Button_Mobile"),
  Buttons = document.querySelector(".Main_Page .Button"),
  icon = document.getElementById("LD_Mode"),
  i = 0,
  j = 0,
  text_style1 = [
  ...
  P1_Mob_background = document.getElementById("EmpireState_building"),
  name_svg_text = document.querySelector(".My_Text .Text"),
  info_span = document.querySelector(".My_Text .Info h1 span"),
  name_svg_mob = document.querySelector(".Page1_Mob .SVG_n svg"),
  name_svg = document.querySelector(".My_Text .Text svg"),
  name_svg_t1 = document.querySelectorAll(".My_Text .Text svg g path"),
  name_svg_t2 = document.querySelectorAll(".Page1_Mob .SVG_n svg g path"),
  text_mob = document.querySelector(".Page1_Tab .Tab_Text h1"),
  text = document.querySelector(".My_Text .Info h1"),
  icons_p1_sub = document.querySelector(".My_Text .Icons .Icons_sub"),
  icons_p1 = document.querySelectorAll(".My_Text .Icons .Icons_sub svg"),
  SVG_tab = document.querySelector(".Page1_Mob .SVG_n svg"),
  Page1_tab = document.querySelector(".Page1_Tab"),
  empirestate_building = document.querySelector(".Page1_Tab .Tab_IMG img"),
  Page2_tab_text = document.querySelector(".Page1_Tab .Tab_Text h1"),
  Page2_tab_text_span = document.querySelector(".Page1_Tab .Tab_Text h1 span"),
  Page2 = document.querySelector(".Page2"),
  about_heading = document.querySelector(".About_texts .Sub1 h1"),
  about_para = document.querySelector(".About_texts .Sub1 p"),
  p2_man_Img = document.querySelector(".About_Images .Man"),
  p2_phone_img = document.querySelector(".About_Images .Iphone"),
  about_images = document.querySelector(".Page2 .Mobile_2 .About_Images"),
  Page3 = document.querySelector(".Page3"),
  skill_heading = document.querySelector(".Page3 .Skills .Sub2 h1"),
  all_Skills_svg = document.querySelectorAll(
    ".Page3 .Mobile_3 .Skills .Sub2 .all_skills div svg"
  ),
  all_Skills_h = document.querySelectorAll(
    ".Page3 .Mobile_3 .Skills .Sub2 .all_skills div h2"
  ),
  p3_ipad = document.querySelector(".Images_2 .Ipad"),
  p3_lady = document.querySelector(".Images_2 .Woman"),
  Page3_Images = document.querySelector(".Page3 .Mobile_3 .Images_2"),
  Page4 = document.querySelector(".Page4"),
  P4_heading = document.querySelector(".Page4 .Mobile_4 .P_heading h1"),
  Project_h1 = document.querySelector(".Projects .Pr_heading h1"),
  Internship_h1 = document.querySelector(".Internships .In_headings h1"),
  Pc_sub = document.querySelector(".P_contents .P_cSub"),
  PR_Card1 = document.querySelector(".Pr_cards .PR_card1"),
  PR_Card2 = document.querySelector(".Pr_cards .PR_card2"),
  IN_Card1 = document.querySelector(".In_cards .IN_card1"),
  IN_Card2 = document.querySelector(".In_cards .IN_card2"),
  Page5 = document.querySelector(".Page5"),
  thanks = document.querySelector(".Page5 .Mobile_5 svg"),
  copyright = document.querySelector(".Page5 .Mobile_5 .Copy h1"),
  Bottoms_icons = document.querySelectorAll(
    ".Page5 .Mobile_5 .Copy .Bottom_icons .Bottom_icon_sub svg"
  ),
  Bottoms_icons_sub = document.querySelector(
    ".Page5 .Mobile_5 .Copy .Bottom_icons .Bottom_icon_sub"
  ),
  Project_main = document.querySelector(".Project_Main"),
  tab_phone_close = document.querySelector(
    ".Project_Main .Project_Link .Tab_Phone_Close"
  ),
  Close_button = document.querySelector(".Project_Main .Close_button"),
  Project_main_2 = document.querySelector(".Project_Main_2"),
  tab_phone_close_2 = document.querySelector(
    ".Project_Main_2 .Project_Link_2 .Tab_Phone_Close_2"
  ),
  Close_button_2 = document.querySelector(".Project_Main_2 .Close_button_2"),
  Internship_main = document.querySelector(".Internship_Main"),
  IT_tab_phone_close = document.querySelector(
    ".Internship_Main .Internship_Link .IT_Tab_Phone_Close"
  ),
  IT_Close_button = document.querySelector(".Internship_Main .IT_Close_button"),
  Internship_main_2 = document.querySelector(".Internship_Main_2"),
  IT_tab_phone_close_2 = document.querySelector(
    ".Internship_Main_2 .Internship_Link_2 .IT_Tab_Phone_Close_2"
  ),
  IT_Close_button_2 = document.querySelector(
    ".Internship_Main_2 .IT_Close_button_2"
  ),
  popup = document.querySelector(".Popup_Pc"),
  popup_svg = document.querySelector(".Popup_Pc .Popup_sub .Top_part svg"),
  popup_sub_text1 = document.querySelector(
    ".Popup_Pc .Popup_sub .Top_part .Top_subPart h1"
  ),
  popup_bottom_text1 = document.querySelector(
    ".Popup_Pc .Popup_sub .Bottom_part .Pc h1"
  ),
  popup_mob_tab = document.querySelector(".Popup_Pc_2"),
  popup_mob_svg = document.querySelector(
    ".Popup_Pc_2 .Popup_sub_2 .Top_part_2 svg"
  ),
  popup_mob_text2 = document.querySelector(
    ".Popup_Pc_2 .Popup_sub_2 .Top_part_2 .Top_subPart_2 h1"
  ),
  popup_bottom_text2 = document.querySelector(
    ".Popup_Pc_2 .Popup_sub_2 .Bottom_part_2 .Pc_2 h1"
  ),
...
function Page1_Light_Mob() {
  ...
  for (var e = 0; e < name_svg_t2.length; e++)
    name_svg_t2[e].style.stroke = "black";
...
function Page1_Dark_Mob() {
  ...
  for (var e = 0; e < name_svg_t2.length; e++)
    name_svg_t2[e].style.stroke = "white";
...
function Page1_Light() {
  ...
  for (var e = 0; e < name_svg_t1.length; e++)
    name_svg_t1[e].style.stroke = "black";
  name_svg.style.stroke = "black";
  for (e = 0; e < icons_p1.length; e++) icons_p1[e].style.fill = "black";
}
function Page1_Dark() {
  ...
  for (var e = 0; e < name_svg_t1.length; e++)
    name_svg_t1[e].style.stroke = "white";
  name_svg.style.stroke = "white";
  for (var t = 0; t < icons_p1.length; t++) icons_p1[t].style.fill = "white";
}
...
function Page3_Light() {
  ...
  for (var e = 0; e < all_Skills_svg.length; e++)
    (all_Skills_svg[
      e
    ].style.transition = `transform ${maxTiltEffectSetting.speed}ms ${maxTiltEffectSetting.easing}`),
      (all_Skills_svg[e].style.fill = "black");
  for (e = 0; e < all_Skills_h.length; e++)
    all_Skills_h[e].style.color = "black";
}
function Page3_Dark() {
  ...
  for (var e = 0; e < all_Skills_svg.length; e++)
    (all_Skills_svg[
      ...
      (all_Skills_svg[e].style.fill = "white");
  for (e = 0; e < all_Skills_h.length; e++)
    all_Skills_h[e].style.color = "white";
}
...
function Page5_Light() {
  ...
  for (var e = 0; e < Bottoms_icons.length; ++e)
    Bottoms_icons[e].style.fill = "black";
}
function Page5_Dark() {
  ...
  for (var e = 0; e < Bottoms_icons.length; ++e)
    Bottoms_icons[e].style.fill = "white";
}
...
function animationSequence() {
  screen.width > 1025
    ...
    : screen.width > 500 && screen.width < 1025
...
function Page1ScrollP1() {
  ...
  for (var e = 0; e < name_svg.length; e++)
    name_svg[e].style.fill = e % 2 == 0 ? "white" : "black";
...
function Page1ScrollP1else() {
  ...
  for (var e = 0; e < name_svg.length; e++) name_svg[e].style.fill = "none";
...
function Page1Scroll() {
  window.scrollY > 10
    ? (Page1ScrollP1(), Page1ScrollP2())
    : (Page1ScrollP1else(), Page1Scrol2P1else());
}
...
function Page2Scroll() {
  let e = Page2.getBoundingClientRect(),
    t = e.y,
    o = e.height;
  d_height > t + (2 * o) / 3 ? Page2ScrollText() : Page2ScrollTextelse();
}
...
function Page3ScrollText() {
  (skill_heading.style.marginLeft = "0vw"), (skill_heading.style.opacity = "1");
  for (var e = 0; e < all_Skills_svg.length; e++)
    (all_Skills_svg[e].style.marginLeft = "0vw"),
      (all_Skills_svg[e].style.opacity = "1");
...
function Page3ScrollTextelse() {
  ...
  for (var e = 0; e < all_Skills_svg.length; e++)
    (all_Skills_svg[e].style.marginLeft = "30vw"),
      (all_Skills_svg[e].style.opacity = "0");
...
function Page3Scroll() {
  let e = Page3.getBoundingClientRect(),
    t = e.y,
    o = e.height;
  d_height > t + (2 * o) / 3 ? Page3ScrollText() : Page3ScrollTextelse();
}
...
function Page4Scroll() {
  let e = Page4.getBoundingClientRect(),
    t = e.y,
    o = e.height;
  d_height > t + (2 * o) / 3 ? page4Scroll() : page4Scrollelse();
}
function Page5Scroll() {
  let e = Page5.getBoundingClientRect(),
    t = e.y,
    o = e.height;
  d_height > t + (2 * o) / 3
...
function Page1_5_Scroll_tab() {
  let e = Page1_tab.getBoundingClientRect(),
    t = e.y,
    o = e.height;
  d_height > t + (2 * o) / 3
...
function Page3ScrollText_tab() {
  ...
  for (e = 0; e < all_Skills_h.length; e++) all_Skills_h[e].style.opacity = "1";
}
function Page3ScrollText_tabelse() {
  ...
  for (e = 0; e < all_Skills_h.length; e++) all_Skills_h[e].style.opacity = "0";
}
...
function Page4Scroll_tab() {
  let e = Page4.getBoundingClientRect(),
    t = e.y,
    o = e.height;
  d_height > t + (2 * o) / 3 ? page4Scroll_tab() : page4Scroll_tabelse();
}
...
function Page4Scroll_Mob() {
  let e = Page4.getBoundingClientRect(),
    t = e.y,
    o = e.height;
  d_height > t + (1 * o) / 3 ? page4Scroll_Mob() : page4Scroll_Mobelse();
}
  ...
  console.log(screen.orientation),
    PC.matches
      ? (window.onorientationchange = () => {
          j % 2 == 0
            ? (console.log("kinda"), (popup.style.display = "flex"), j++)
            : (console.log("not kinda"), (popup.style.display = "none"), j++);
        })
      : TAB.matches &&
        (console.log(screen.orientation),
        (window.onorientationchange = () => {
...
function Infinite_Text() {
  setInterval(() => {
    num < text_style1.length
      ? ((info_span.style.fontFamily = text_style1[num]), num++)
      : num >= text_style1.length && num > 0 && (num = 0);
  }, 500);
}
function Infinite_Text_Tab() {
  ...
  setInterval(() => {
    e < text_style.length
      ? ((Page2_tab_text_span.style.fontFamily = text_style[e]), e++)
      : e >= text_style.length && e > 0 && (e = 0);
  }, 300);
}
(Buttons.onclick = () => {
  i % 2 == 0
  ...
  (Button_Mob.onclick = () => {
    i % 2 == 0
      ? ((mainPage.style.background = "black"),
        ...
        (Button_Mob.style.boxShadow =
          "5px 5px 5px 2px rgba(255, 255, 255, 0.5)"),
        Page1_Dark_Mob(),
        Page2_Dark(),
        Page3_Dark(),
        Page4_Dark(),
  ...
  document.addEventListener("scroll", (e) => {
    scrollY > 10 ? (Buttons.style.opacity = 1) : (Buttons.style.opacity = 0);
  }),
